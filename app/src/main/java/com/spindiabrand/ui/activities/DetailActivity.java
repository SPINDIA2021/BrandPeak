...
import static com.spindiabrand.utils.Constant.INTENT_BUSINESS_ITEM;
import static com.spindiabrand.utils.Constant.INTENT_POS;
import static com.spindiabrand.utils.Constant.INTENT_POST_IMAGE;
import static com.spindiabrand.utils.Constant.INTENT_POST_ITEM;
import static com.spindiabrand.utils.Constant.INTENT_TYPE;
...
import com.spindiabrand.adapters.LanguageAdapter;
import com.spindiabrand.binding.GlideBinding;
import com.spindiabrand.databinding.ActivityDetailBinding;
...
import com.spindiabrand.viewmodel.LanguageViewModel;
    ...
    private void setSubData(List<BusinessSubCategoryItem> data) {
        ...
        binding.cgImage.setOnCheckedStateChangeListener(new ChipGroup.OnCheckedStateChangeListener() {
            ...
            public void onCheckedChanged(@NonNull ChipGroup group, @NonNull List<Integer> checkedIds) {
                ...
                com.spindiabrand.utils.Util.showLog("CheckedID: " + getChipName(group.getCheckedChipId()));
...
//                    Toast.makeText(DetailActivity.this, "Error occurred! Please Give Permission", Toast.LENGTH_SHORT).show();
        ...
        binding.tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                com.spindiabrand.utils.Util.showLog("" + tab.getId()
                        + tab.getText());
    ...
    private void setData(List<PostItem> data) {
        ...
        com.spindiabrand.utils.Util.showLog("Video: " + isVideo);
        if (!isVideo) {
            binding.tabLayout.setVisibility(GONE);
        } else {
