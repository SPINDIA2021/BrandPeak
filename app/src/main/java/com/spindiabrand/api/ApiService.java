...
public interface ApiService {
    ...
    //******* Get Refer Withdrawal Details ******
    @GET("{API_KEY}/withdraw-list")
    LiveData<ApiResponse<ReferWithdrawalDetail>> getReferWithdrawalDetails(@Path("API_KEY") String apiKey, @Query("userId") String id);
