...
public class ImageUtils {
    ...
    public static Bitmap getBgCircleBit(Context context, int i) {
        ...
        return bitmapmasking1(getTiledBitmap(context, i, dpToPx, dpToPx), Bitmap.createScaledBitmap(BitmapFactory.decodeResource(context.getResources(),
                R.drawable.circle), dpToPx, dpToPx, true));
    }
