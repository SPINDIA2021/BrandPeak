...
public class HomeItem {
    ...
    @TypeConverters
    @SerializedName("customvedio")
    public List<CustomVideoItem> customvedio;

    public HomeItem(int id, List<StoryItem> storyItemList, List<FestivalItem> festivalItemList, List<FeatureItem> featureItemList, List<BusinessCategoryItem> businessCategoryList, List<CategoryItem> categoryList, List<CustomVideoItem> customvedio) {
        this.id = id;
