...
import com.spindiabrand.repository.UserRepository;
...
public class UserViewModel extends AndroidViewModel {
    ...
    private MutableLiveData<String> referWithdrawalObj = new MutableLiveData<>();
    ...
    public LiveData<Resource<ReferWithdrawalDetail>>getReferWithdrawalDetail(String userId, String objs) {
        referWithdrawalObj.setValue(objs);
        return Transformations.switchMap(referWithdrawalObj, obj->{
            if(obj==null){
                return AbsentLiveData.create();
            }
            return userRepository.getReferWithdrawalDetail(prefManager.getString(Constant.api_key), userId);
        });
    }
}
